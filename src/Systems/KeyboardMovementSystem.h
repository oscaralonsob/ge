...
public:
    ...
    void OnKeyPressed(KeyPressedEvent& event) {
        if (event.symbol != SDLK_UP && event.symbol != SDLK_RIGHT &&
            event.symbol != SDLK_DOWN && event.symbol != SDLK_LEFT) {
            return;
        }
        ...
        for (Entity entity : GetSystemEntities()) {
            ...
            case SDLK_UP:
                rigidBodyComponent.velocity =
                    keyboardControllerComponent.upVelocity;
                spriteComponent.offset = glm::vec2(0.0, 0.0);
                break;
            case SDLK_RIGHT:
                rigidBodyComponent.velocity =
                    keyboardControllerComponent.rightVelocity;
                spriteComponent.offset = glm::vec2(0.0, 1.0);
                break;
            case SDLK_DOWN:
                rigidBodyComponent.velocity =
                    keyboardControllerComponent.downVelocity;
                spriteComponent.offset = glm::vec2(0.0, 2.0);
                break;
            case SDLK_LEFT:
                rigidBodyComponent.velocity =
                    keyboardControllerComponent.leftVelocity;
